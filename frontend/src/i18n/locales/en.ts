export default {
  ...
  setup: {
    title: 'TokenQS Setup',
    description: 'Configure your TokenQS instance',
    database: {
  ...
  keys: {
    ...
    quotaAmountPlaceholder: 'Enter quota limit in RMB',
    ...
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (RMB)',
    rateLimit1d: 'Daily Limit (RMB)',
    rateLimit7d: '7-Day Limit (RMB)',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. tokenqs-backups), choose a region',
    ...
    users: {
      ...
      platformQuota: {
        ...
        subtitle: 'Configure daily / weekly / monthly RMB usage limits for each upstream platform for user {email}',
        columns: {
          platform: 'Platform',
          daily: 'Daily (RMB)',
          weekly: 'Weekly (RMB)',
          monthly: 'Monthly (RMB, 30-day rolling)',
          usage: 'Current Usage',
        },
    ...
    groups: {
      ...
      subscription: {
        ...
        dailyLimit: 'Daily Limit (RMB)',
        weeklyLimit: 'Weekly Limit (RMB)',
        monthlyLimit: 'Monthly Limit (RMB)',
    ...
    accounts: {
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by TokenQS, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within TokenQS.',
      ...
      quotaLimitHint: 'Set daily/weekly/total spending limits (RMB). Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another TokenQS instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for TokenQS end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for TokenQS end-user login',
      ...
      platformQuota: {
        ...
        daily:       'Daily (RMB)',
        weekly:      'Weekly (RMB)',
        monthly:     'Monthly (RMB, 30d rolling)',
        placeholder: 'Unlimited',
      },
      claudeCode: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many RMB balance the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = {usd} RMB',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to TokenQS',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">TokenQS is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of TokenQS, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to TokenQS',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the TokenQS AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 CNY = {usd} RMB',
