...
export interface User {
  ...
  role: 'admin' | 'operator_admin' | 'user' // User role for authorization
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'deepseek' | 'minimax' | 'zhipu' | 'seedance'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'deepseek' | 'minimax' | 'zhipu' | 'seedance'
...
export interface UpdateUserRequest {
  ...
  username?: string
  notes?: string
  role?: 'admin' | 'operator_admin' | 'user'
  balance?: number
  concurrency?: number
